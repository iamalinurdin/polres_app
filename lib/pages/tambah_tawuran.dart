...
class TambahTawuranPage extends StatefulWidget {
  const TambahTawuranPage({Key? key}) : super(key: key);

  @override
  State<TambahTawuranPage> createState() => _TambahTawuranPageState();
}

class _TambahTawuranPageState extends State<TambahTawuranPage> {
  File? image;
